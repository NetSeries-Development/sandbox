...
(function () {
  ...
  const config = {
    ...
    description: "We maken gebruik van analytische cookies om anoniem te begrijpen hoe bezoekers onze website gebruiken. Dit helpt ons de ervaring te verbeteren. Je kunt zelf kiezen welke cookies je toestaat.",
  };
